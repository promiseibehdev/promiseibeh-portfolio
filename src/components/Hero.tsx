          ...
          >
            <div className="flex items-center space-x-4">
              <button
                ...
                className="bg-gray-900 hover:bg-brand hover:text-gray-900 text-white font-semibold px-8 py-4 rounded-xl shadow-lg transition-all duration-300 cursor-pointer focus:outline-hidden"
              >
                Hire Me
              </button>
              <button
                ...
                className="bg-white hover:bg-gray-50 border border-gray-300 text-gray-800 font-semibold px-8 py-4 rounded-xl shadow-xs transition-all duration-300 cursor-pointer focus:outline-hidden flex items-center space-x-2"
              >
        ...
        <div className="lg:col-span-5 flex justify-center order-1 lg:order-2">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-4 right-[-20px] bg-white border border-gray-100 shadow-xl py-3 px-5 rounded-2xl flex items-center space-x-3"
            >
            ...
            <motion.div
              ...
              className="absolute top-12 left-[-30px] bg-white border border-gray-100 shadow-xl py-3 px-5 rounded-2xl flex items-center space-x-3"
            >
