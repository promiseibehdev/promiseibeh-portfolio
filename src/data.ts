...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'p3',
    title: 'ThinKaiMotivation Content Studio',
    category: 'automation',
    description: 'An offline-first Streamlit application for organizing motivational content ideas, creating original quotes, writing social-media captions, and planning content schedules for the ThinKaiMotivation brand. The application uses safe local JSON storage and works without AI, API keys, user accounts, subscriptions, or an external database.',
    image: '/images/projects/thinkai.webp.png',
    client: 'ThinKaiMotivation',
    date: 'Version 1.0.0',
    url: 'https://thinkaimotivation-content-studio-gypjdthpkeps5yz7ukj4rj.streamlit.app/',
    liveUrl: 'https://thinkaimotivation-content-studio-gypjdthpkeps5yz7ukj4rj.streamlit.app/',
    githubUrl: 'https://github.com/promiseibehdev/thinkaimotivation-content-studio',
    technologies: ['Python', 'Streamlit', 'Local JSON Storage', 'Pytest', 'Ruff', 'Responsive UI'],
    projectType: 'Productivity Application',
    brand: 'ThinKaiMotivation',
    version: '1.0.0',
  ...
  },
  {
    ...
    category: 'web',
    description: 'A fictional WooCommerce-inspired storefront and security-hardening simulator demonstrating layered Python architecture, catalogue and cart workflows, simulated checkout, deterministic security scoring, remediation planning, and privacy-safe reporting. It is not a live commercial shop and processes no real payments.',
    image: '/images/projects/woocommerce.webp.png',
    client: 'Interactive Portfolio Demo',
    date: 'July 2026',
    url: 'https://woocommerce-storefront-security-hardening-p9d7t7mkrclous9etglr.streamlit.app/',
    liveUrl: 'https://woocommerce-storefront-security-hardening-p9d7t7mkrclous9etglr.streamlit.app/',
    githubUrl: 'https://github.com/promiseibehdev/woocommerce-storefront-security-hardening',
    technologies: ['Python', 'Streamlit', 'WooCommerce Architecture', 'Security Hardening', 'Pytest', 'GitHub Actions'],
    projectType: 'Engineering Simulator',
    version: '1.0.0',
    domain: 'Ecommerce & Cybersecurity',
    status: 'Released',
  },
  {
    id: 'p5',
  ...
  {
    id: 'p6',
    title: 'High-Availability AWS Infrastructure Simulator',
    category: 'automation',
    description: 'An interactive simulation of a production-grade AWS infrastructure built to demonstrate Terraform, networking, high availability, security, monitoring, and disaster recovery. The application visualizes how a real AWS environment behaves without creating or running cloud resources.\n\nThe free, offline simulator requires no AWS account or credentials. It demonstrates multi-AZ availability, EC2 failure and replacement, traffic-driven scaling, Availability Zone outage recovery, simulated CloudWatch monitoring, security and cost-awareness reviews, and an educational Terraform Explorer.',
    image: '/images/projects/aws-cloud.webp.png',
    client: 'Interactive Portfolio Demo',
    date: 'July 2026',
    url: 'https://high-availability-aws-infrastructure-simulator-gmlpy8kitpfmxom.streamlit.app/',
    liveUrl: 'https://high-availability-aws-infrastructure-simulator-gmlpy8kitpfmxom.streamlit.app/',
    githubUrl: 'https://github.com/promiseibehdev/high-availability-aws-infrastructure-simulator',
    technologies: ['Python', 'Streamlit', 'AWS Architecture', 'Terraform', 'Graphviz', 'Pytest', 'GitHub Actions'],
  },
  {
    id: 'p7',
    title: 'Enterprise Corporate Portal & CMS',
    category: 'web',
    description: 'A production-style internal employee portal and CMS built with Python and Streamlit. It includes corporate announcements, an employee directory, departments, document and policy catalogues, internal news, global search, CMS content workflows, validated local persistence, atomic saves, backup and restore, JSON export, and a security review dashboard.',
    image: '/images/projects/corporate-portal.webp.png',
    client: 'Interactive Portfolio Demo',
    date: 'July 2026',
    url: 'https://enterprise-corporate-app-cms-7wbnqz7qkzu7i98ytbgypd.streamlit.app/',
    liveUrl: 'https://enterprise-corporate-app-cms-7wbnqz7qkzu7i98ytbgypd.streamlit.app/',
    githubUrl: 'https://github.com/promiseibehdev/enterprise-corporate-portal-cms',
    sourceLabel: 'View Source',
    technologies: ['Python', 'Streamlit', 'Pytest', 'Ruff', 'JSON', 'GitHub Actions'],
  },
  {
    id: 'p8',
